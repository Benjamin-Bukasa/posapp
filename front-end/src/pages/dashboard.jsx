...
function Dashboard() {
  ...
  return (
    <section className="sectionDashboard">
      ...
      <div className="sideBloc flex flex-col gap-4">
            ...
            {loading ? (
              ...
              pendingRequisitions.map((item) => (
                <div key={item.id} className="flex items-center justify-between">
                  <div>
                    <p className="text-text-primary">{item.id}</p>
                    <p className="text-xs text-text-secondary">{item.store}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-warning">{item.status}</p>
        ...
        <div className="rounded-lg border border-border bg-background p-3">
          ...
          <div className="mt-3 space-y-3 text-sm">
            {loading ? (
              ...
              <p className="text-xs text-text-secondary">Aucune alerte</p>
            ) : (
              stockAlerts.map((item) => (
                <div key={item.id} className="flex items-center justify-between">
                  <div>
                    <p className="text-text-primary">{item.name}</p>
                    <p className="text-xs text-text-secondary">{item.stock}</p>
                  </div>
