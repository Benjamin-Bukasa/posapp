...
const inputClassName =
  "w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text-primary outline-none transition focus:ring-2 focus:ring-accent";
        ...
        <div className="absolute inset-y-0 right-3 flex items-center gap-1">
          {value ? (
            <button
              ...
              onClick={handleClear}
              disabled={disabled}
              className="rounded-md p-1 text-text-secondary hover:bg-surface/70 hover:text-text-primary disabled:cursor-not-allowed disabled:opacity-50"
              aria-label="Effacer"
            >
