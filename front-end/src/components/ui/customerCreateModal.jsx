  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-3 sm:p-4">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative flex max-h-[calc(100dvh-1.5rem)] w-full max-w-xl flex-col overflow-hidden rounded-2xl bg-surface shadow-2xl ring-1 ring-black/5 sm:max-h-[90vh]">
        ...
        <div className="flex shrink-0 flex-col-reverse gap-2 border-t border-border bg-surface/95 px-4 py-4 backdrop-blur sm:flex-row sm:items-center sm:justify-end sm:px-6">
          <button
            type="button"
            onClick={onClose}
            className="w-full rounded-lg bg-background px-4 py-2 text-sm font-medium text-text-primary hover:bg-surface dark:bg-surface dark:border dark:border-border dark:hover:bg-surface/70 sm:w-auto"
          >
            Annuler
          </button>
          <button
            ...
            disabled={submitting}
            className={[
              "w-full rounded-lg px-4 py-2 text-sm font-medium text-white sm:w-auto",
              submitting
